...
| дата       | длительность | тулчейн            | exec/s | итого итераций | cov | крашей | примечания                                                                           |
|------------|--------------|--------------------|--------|----------------|-----|--------|--------------------------------------------------------------------------------------|
| 2026-06-15 | ~50 мин      | nightly-2026-05-22 | ~35k   | ~104M          | 841 | 0      | дефолтные флаги, ASan включён, покрытие насытилось рано, только REDUCE после ~7M |

**Насыщение покрытия** на `cov: 841 ft: 4762 corp: 1679/298Kb` означает что
